...
class PylonClient(BaseClient):
    ...
    def get_accounts(self) -> list[dict]:
        ...
        if response.status_code != 200:
            raise Exception("Failed to retrive the pylon accounts request returned error code: {response.status_code}")
    ...
    def get_account(self, account_name :str) -> dict:
        ...
        if account is None:
            raise Exception("Account not found in python, please check your company name input")
        return account
